...
public class CreateZip {
  ...
  protected static final String password = "ascya20Augabc";
  protected static final String loginHost = "https://test.salesforce.com";*/
    ...
    protected static final String password="dhasjk@#ahd12";
    ...
    public String getZipFilePath(String DirName) throws IOException {
        Files.createDirectories(Paths.get("C:\\DownloadZip\\"+DirName));
        return "C:\\DownloadZip\\"+DirName+"\\";
    }

    public void getZipFile(String[] ids, String zipFileName, String logFileName,String zipFilePath) throws IOException {
        ...
        for (String id: ids) {
         ...
         zipFiles(zipFilePath,zipFileName,logFileName);
    }

    private  void zipFiles(String zipFilePath,String zipFileName, String logFileName) {
        try {
